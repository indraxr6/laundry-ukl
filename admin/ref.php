    ...
    <a class="navbar-item --jb-navbar-menu-toggle" data-target="navbar-menu">
      ...
      <div class="navbar-item dropdown has-divider has-user-avatar">
        <a class="navbar-link">
          ...
          <div class="is-user-name"><span><?=$_SESSION['nama']?></span></div>
          
        </a>
     
      <a href="https://github.com/indraxr6" class="navbar-item has-divider desktop-icon-only" target="_blank">
...
<aside class="aside is-placed-left is-expanded">
  <div class="aside-tools">
    <div>
      Laundry <b class="font-black">APP</b>
    </div>
  </div>
    ...
    <ul class="menu-list">
      ...
      <li class="">
        <a href="outlet.php">
          ...
          <span class="menu-item-label">Outlet</span>
        </a>
      </li>
      <!-- pelanggan -->
      <li class="">
        ...
        <li class="">
        <a href="paket.php">
          <span class="icon"><i class="mdi mdi-tshirt-crew"></i></span>
...
<!-- login -->
    ...
    <ul class="menu-list">
      ...
      <li>
        <a href="https://github.com/indraxr6" class="has-icon" target="_blank">
          <span class="icon"><i class="mdi mdi-github-circle"></i></span>
