    ...
    <div class="card mb-6">
      <header class="card-header">
        <p class="card-header-title">
          ...
          Form edit untuk data pelanggan
        </p>
      </header>
      <div class="card-content">
        <form action="proses_ubah_member.php? id= <?php echo $_GET['id'] ?> " method="post">
  ...
  ?>
        ...
        <div class="field">    
            ...
            <!-- nama -->
              ...
              <div class="field">
                <div class="control icons-left icons-right">
                  <input class="input" type="text" placeholder="Alamat"  name="alamat" value= "<?php echo $data['alamat']?> ">
              ...
              <div class="field">
                <div class="field addons">
                  ...
                  <div class="control expanded">
                    <input class="input" type="text" name="tlp" value= "<?php echo $data['tlp']?> ">
                  </div>
                </div>
          ...
          <div class="field">
            ...
            <div class="control">
              <div class="select">
                <select placeholder="Jenis Kelamin" name="jenis_kelamin" value= "<?php echo $data['jenis_kelamin']?> ">
