...
<section class="is-hero-bar">
  <div class="flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0">
    ...
    <a href="outlet.php" class="button light">Kembali</a>
  </div>
</section>
  ...
  <section class="section main-section">
    <div class="card mb-6">
      ...
      <div class="card-content">
        <form action="proses_ubah_outlet.php? id= <?php echo $_GET['id'] ?> " method="post">
              ...
              <div class="field">
                <div class="field addons">
                  ...
                  <div class="control expanded">
                    <input class="input" type="text" c name="tlp" value= "<?php echo $data['tlp']?> ">
                  </div>
                </div>
