...
$qry_user=mysqli_query($conn,"select transaksi.*, member.nama from transaksi inner join member on member.id = transaksi.id_member");
...
?>
            ...
            <td><?=$data_user['tgl']?></td>
            <td><?=$data_user['tgl_bayar'] ?></td>  
            <td ><?=$data_user['batas_waktu']?></td>
            ...
            <td class="actions-cell">
              ...
              <a href="detail_transaksi.php?id=<?=$data_user['id']?>" class="button medium green --jb-modal" type="button">
                ...
                <a  href="hapus_transaksi.php?id=<?=$data_user['id']?>" class="button medium red --jb-modal" type="button">
