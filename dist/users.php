...
<section class="is-hero-bar">
  <div class="flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0">
    <h1 class="title">
      Tabel Pengguna (Kasir dan Admin)
    </h1>
    <a href="add_user.php" class="button light">Tambah</a>
  </div>
</section>
          ...
          <!-- //BADGE  -->
            ...
            <td class="actions-cell">
              <div class="buttons left nowrap">
                <a href="edit_user.php?id=<?=$data_user['id']?>" class="button medium blue --jb-modal" type="button">
                  <span class="icon"><i class="mdi mdi-pencil"></i></span>
                </a>
                <a  href="hapus_user.php?id=<?=$data_user['id']?>" class="button medium red --jb-modal" type="button">
