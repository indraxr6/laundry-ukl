...
<section class="is-hero-bar">
  <div class="flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0">
    ...
    <a href="add_pelanggan.php" class="button light">Tambah</a>
  </div>
</section>
          ...
          <!-- //BADGE  -->
            ...
            <td class="actions-cell">
              <div class="buttons left nowrap">
                <a href="edit_member.php?id=<?=$data['id']?>" class="button medium blue --jb-modal" type="button">
                  <span class="icon"><i class="mdi mdi-pencil"></i></span>
                </a>
                <a  href="hapus_member.php?id=<?=$data['id']?>" class="button medium red --jb-modal" type="button">
