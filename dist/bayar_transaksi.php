...
<?php 
$sql = "select * from transaksi inner join detil_transaksi on detil_transaksi.id where id_transaksi = ". $_GET['id'];
  ...
  <section class="section main-section">
    <div class="card mb-6">
      ...
      <div class="card-content">
        <form action="proses_bayar.php?id=<?php echo $_GET['id'] ?> " method="post">
          <div class="field">
          ...
          <div class="field">
            ...
            <div class="control">
              <div class="select">
                <select name="nama">
                <option value= "<?php echo $data['tgl'] ?>"></option>
                <?php
        include "koneksi.php";
    ...
    ?>
          ...
          <div class="field">
            ...
            <div class="control">
              ...
              <input class="input" placeholder="Jumlah"  name="tgl_bayar" value="<?=(date("Y-m-d | H:i"))?>">
              </div>
            </div>
          </div>
           ...
           <div class="field">
            ...
            <div class="control">
              <div class="select">
              <input class="input" name="batas_waktu" value= "<?php echo $data['batas_waktu'] ?>" readonly>
              </div>
            </div>
          </div>
