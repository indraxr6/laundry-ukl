...
while($data =mysqli_fetch_array($qry)){
    ...
    <td><a href="ubah_outlet.php?id=<?=$data['id']?>" class="btn btn-success">Ubah</a> 
    <a href="hapus_outlet.php?id=<?=$data['id']?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-danger">Hapus</a></td>
    </tr>

<?php
}
?>
<td><a href="tambah_outlet.php" class="btn btn-success">Tambah outlet</a></td>
